...
list.of.packages <- c("ggplot2", "magick","sp","raster","rgdal","hydroGOF","gridExtra","ggthemes","grid",
                      ...
                      "maptools","ggpubr","geosphere","viridis","broom","classInt","reshape2")
...
setwd(paste(default,"/Data/Input/Sentinel-1/ValidationTraining/TC",sep=""))
...
setwd(paste(default,"/Data/Input/Sentinel-1/Images/TC",sep=""))
